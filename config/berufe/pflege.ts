...
const pflege: BerufConfig = {
  ...
  lernfeldMap: {
    ...
    "recht|schweigepflicht|datenschutz|haftung|pflegegesetz|betreuungsrecht|freiheitsentziehung|dokumentationspflicht|dsgvo|pflbg":
      "Querschnittsthema: Recht und Ethik in der Pflege. Prüfungsrelevanz: KB IV, Klausur 3. Kernbegriffe: Schweigepflicht §203 StGB, Dokumentationspflicht, PflBG, Betreuungsrecht, Freiheitsentziehende Maßnahmen (FEM), Haftungsrecht, Patientenverfügung, DSGVO in der Pflege. Alltagsbezug: Die Tochter einer Bewohnerin ruft an und fragt: 'Was hat der Arzt gesagt?' — darfst du Auskunft geben?",
